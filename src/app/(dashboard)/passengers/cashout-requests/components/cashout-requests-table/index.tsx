...
export function CashoutRequestsTable() {
  ...
  const columns = React.useMemo<ColumnDef<PassengerCashoutRequest>[]>(
    () => [
      {
        accessorFn: (row) => row.passenger?.name ?? "Unknown Passenger",
        id: "passengerName",
      ...
      {
        accessorFn: (row) => row.passenger?.walletSummary!.actualBalance,
        id: "actualBalance",
      ...
      {
        accessorFn: (row) => row.passenger?.walletSummary!.addedBalance,
        id: "addedBalance",
            ...
            <>
              <Sheet>
                ...
                <SheetContent className="overflow-y-auto">
                  <SheetHeader>
                    <SheetTitle>{passenger?.name} Cashout Request</SheetTitle>

                    <SheetDescription>
                      Review {passenger?.name} request from{" "}
                      <time className="text-start">
                  ...
                  <div className="grid flex-1 auto-rows-min gap-6">
                    ...
                    <div>
                      ...
                      <div className="text-sm">
                        {passenger?.walletSummary!.totalBalance}
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="text-sm">
                        {passenger?.walletSummary!.actualBalance}
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="text-sm">
                        {passenger?.walletSummary!.addedBalance}
                      </div>
                    </div>
  ...
  return (
    <div className="w-full">
      <div className="flex items-center py-4">
        <Input
          placeholder="Filter passenger names..."
          value={
            (table.getColumn("passengerName")?.getFilterValue() as string) ?? ""
          }
          onChange={(e) =>
            table.getColumn("passengerName")?.setFilterValue(e.target.value)
          }
          className="max-w-sm"
        />
        <DropdownMenu>
